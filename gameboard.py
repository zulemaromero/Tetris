...
screen_w = 640
screen_h = 480
screen = pygame.display.set_mode((screen_w,screen_h), 0, 0)
pygame.display.set_caption("Tetris")
font = pygame.font.SysFont("arial black", 16)

clock = pygame.time.Clock()
cell_image = pygame.image.load('fondo.png').convert()
cell_image.set_colorkey((255,0,255))
shape_1_image = pygame.image.load('rojo.png').convert()
shape_1_image.set_colorkey((255,0,255))
shape_2_image = pygame.image.load('naranja.png').convert()
shape_2_image.set_colorkey((255,0,255))
shape_3_image = pygame.image.load('amarillo.png').convert()
shape_3_image.set_colorkey((255,0,255))
shape_4_image = pygame.image.load('verde.png').convert()
shape_4_image.set_colorkey((255,0,255))
shape_5_image = pygame.image.load('azul.png').convert()
shape_5_image.set_colorkey((255,0,255))
shape_6_image = pygame.image.load('lila.png').convert()
shape_6_image.set_colorkey((255,0,255))
shape_7_image = pygame.image.load('gris.png').convert()
...
class New_Game_Button(Button):
    def __init__(self, parent, position = (100,300)):
...
class GameBoard:
    def __init__(self):
        ...
        self.level = 1
        self.score = 0
        Pause_Button(self, (10,440))
        New_Game_Button(self,(115,440))
    ...
    def draw(self, surface):
        ...
        surface.blit(board_bg, (219,70))
        x = (self.cols + 1) * self.cell_width
        y = self.cell_height
        surface.blit(self.queue_image, (453,128))
        #pygame.draw.rect(surface, (0,0,0), ((x-1,y-1),(self.queue_image.get_width()+2, self.queue_image.get_height()+2)), 2)
        surface.blit(font.render("LEVEL: %d" %self.level, True, (255,255,255)), (460,10))
        surface.blit(font.render("LINES: %d" %self.lines_done, True, (255,255,255)), (460,43))
        surface.blit(font.render("SCORE: %d" %self.score, True, (255,255,255)), (460,75))
        font_w,font_h = font.size("NEXT")
        x += ((self.queue_image.get_width()/2) - (font_w/2))
        y -= font_h
        border_topx, border_topy = self.cells[0][0].rect.topleft
        border_btmx, border_btmy = self.cells[0][0].rect.bottomright
